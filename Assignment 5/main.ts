...
let famousPerson : string = "ImranKhan";

let message : string = `${famousPerson} once said, "It is not defeat that destroy you ,
it is being demoralized by defeat that destroy you."`;

// Printing the famous quote and its author
